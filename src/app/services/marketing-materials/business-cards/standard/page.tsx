...
type Weight = '14pt' | '16pt'

const FINISHES: { id: Finish; label: string; description: string }[] = [
  { id: 'matte',    label: 'Matte',    description: 'Smooth, non-reflective finish. Clean and modern look.' },
  { id: 'gloss',   label: 'Gloss',    description: 'High-shine UV coating. Colors pop, great for photos and bold designs.' },
  { id: 'uncoated',label: 'Uncoated', description: 'Natural, tactile surface. Writable — ideal for an organic brand feel.' },
]
...
function Configurator() {
  ...
  const handleQuote = () => {
    ...
    const details = `Standard Business Card — ${f} finish, ${s}, ${w} stock`
    router.push(`/get-quote?product=${encodeURIComponent('Standard Business Card')}&details=${encodeURIComponent(details)}`)
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_520px] gap-12 items-start">
            ...
            <div className="order-1 lg:order-first">
              ...
              <div className="lg:hidden mb-8 border-t border-gray-200 pt-5">
                <Link href="/get-quote?product=Standard%20Business%20Card">
                  <Button
                    size="lg"
