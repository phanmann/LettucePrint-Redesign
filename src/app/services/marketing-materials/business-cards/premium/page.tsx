...
import PremiumBusinessCardCalculator from '@/components/shop/PremiumBusinessCardCalculator'

const specs = [
  { label: 'Size', value: '3.5" × 2" (standard)' },
  { label: 'Finish options', value: 'Soft Touch, Raised Spot Gloss, Raised Foil, Extra Thick' },
  { label: 'Stock weights', value: '14 pt, 16 pt, 38 pt (Extra Thick)' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_600px] gap-12 items-start">
            ...
            <div className="hidden lg:block lg:order-last lg:sticky lg:top-24">
              <PremiumBusinessCardCalculator productName="Premium Business Cards" />
            </div>
            ...
            <div className="lg:order-first">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <Badge variant="new">Luxury Finishes</Badge>
                </div>
                ...
                <p className="text-body-lg text-gray-600 leading-relaxed">
                  Elevated finishes that make a lasting first impression — soft-touch laminate, raised spot gloss, metallic foil, and extra-thick 38pt board. For brands that want to leave an impression.
                </p>
              </div>
              ...
              <ProductImageGallery
                images={[
                  ...
                  { src: 'https://drive.usercontent.google.com/download?id=1LYzqKl5GRanrRWxBdsn_tnLxmp2dau-D&export=view', alt: 'Business card finishes' },
                ]}
              />
              ...
              <div className="rounded-card border border-gray-200 p-6">
                <h3 className="text-h4 font-semibold text-gray-900 mb-2">Want something simpler?</h3>
                <p className="text-small text-gray-600 mb-4">Matte, gloss, or uncoated standard cards with fast turnaround.</p>
          ...
          <div className="mt-20 pt-12 border-t border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Link href="/services/marketing-materials/business-cards/standard" className="group block bg-white rounded-card shadow-card hover:shadow-card-hover border border-gray-100 p-6 transition-all duration-250">
                <Badge variant="new" className="mb-4">Fast</Badge>
                ...
                <p className="text-small text-gray-600 mb-4">Clean matte or gloss finishes with 2–3 day turnaround.</p>
              ...
              <Link href="/shop/stickers" className="group block bg-lp-black rounded-card p-6 transition-all duration-250 hover:opacity-90">
                <Badge variant="popular" className="mb-4">Popular</Badge>
                <h3 className="text-h4 font-semibold text-white mb-2">Custom Stickers</h3>
                <p className="text-small text-white/70 mb-4">Die-cut vinyl stickers in any shape. Perfect for packaging and branding.</p>
                <span className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-lp-green">View product <ArrowRight size={12} /></span>
              </Link>
            </div>
          </div>
