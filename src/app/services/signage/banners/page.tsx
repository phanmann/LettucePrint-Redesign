    ...
    products: [
      {
        ...
        subtitle: '33" × 80", 48" × 80", or 60" × 80"',
        description: 'One standard pull-up banner system with size options for booths, retail displays, and event signage.',
        features: ['Aluminum base', 'Full-color print', 'Carrying bag included', 'Setup in under 60 seconds'],
        options: [{ label: 'Sizes', values: ['33" × 80"', '48" × 80"', '60" × 80"'] }],
      ...
      },
      {
        ...
        turnaround: '3–5 business days',
        color: '#F5F0E8',
        image: '/images/products/banners/retractable-tabletop/tabletop-retractable.webp',
        imageFit: 'contain' as const,
      },
    ],
  },
